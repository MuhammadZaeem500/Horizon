...
const accordionData: AccordionItem[] = [
  {
    step: 1,
    title: "Submission of Public Deed Confirming Capital Increase in an Existing Company",
    content:
  ...
  },
  {
    step: 3,
    title:
      "Operating License Number and Issuing Municipality Details",
    content:
      "Evidence of submission and payment of the company's most recent annual income tax return, demonstrating its operational status during the fiscal year preceding the application submission.",
  },
  {
    step: 4,
    title:
      "Proof of Investment via International Transfer of $150,000 or More",
    content:
      "Evidence of submission and payment of the company's most recent annual income tax return, demonstrating its operational status during the fiscal year preceding the application submission.",
  },
];
...
const Recommendation: React.FC = () => {
    ...
    <div className="bg-[#F9FAFC] flex flex-col md:flex-row gap-[20px] px-[20px] md:px-[10%] py-8 md:py-[50px] items-center">
      ...
      <div className="flex-1 w-full md:w-1/2">
        ...
        {accordionData.map((item, index) => (
          <div key={index} className="mb-2 md:mb-4 pb-2 md:pb-4"> {/* Removed border-b */}
            {/* Accordion Header */}
            <div
            ...
            >
              <p className="mt-2  text-xs md:text-sm font-medium text-[#0E2A3F]">{item.content}</p>
            </div>
  ...
  src={commitmentImage}
  alt="Our Commitment"
  className="object-cover w-full max-w-[300px] md:max-w-[300px] lg:max-w-[500px] h-[300px] md:h-[500px] lg:h-auto shadow-md"
  layout="intrinsic"
  width={500}
  height={500}
/>
